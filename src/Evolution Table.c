...
//	[SPECIES_MACHAMP] =          {{EVO_GIGANTAMAX, TRUE, SPECIES_MACHAMP_GIGA, 0}},
	...
	[SPECIES_WEEPINBELL] =       {{EVO_ITEM, ITEM_LEAF_STONE, SPECIES_VICTREEBEL, 0}},
								 {{EVO_ITEM, ITEM_SUN_STONE, SPECIES_EMPOLEON, 0}},
	...
	[SPECIES_MAGNETON] =         {{EVO_MAP, MAP_NAME_SIX_ISLAND, SPECIES_MAGNEZONE, 0}},
	...
	[SPECIES_SHELLDER] =         {{EVO_ITEM, ITEM_WATER_STONE, SPECIES_CLOYSTER, 0}},
								 {{EVO_OTHER_PARTY_MON, SPECIES_SLOWPOKE, SPECIES_PRINPLUP, 0}},
	...
	[SPECIES_LICKITUNG] =        {{EVO_MOVE, MOVE_ROLLOUT, SPECIES_LICKILICKY, 0}},
								 {{EVO_ITEM, ITEM_KINGS_ROCK, SPECIES_LUXIO, 0},
								  {EVO_TRADE_ITEM, ITEM_KINGS_ROCK, SPECIES_LUXIO, 0}},
	...
	[SPECIES_TANGELA] =          {{EVO_MOVE, MOVE_GRASSKNOT, SPECIES_GROTLE, 0}},
	...
	[SPECIES_EEVEE] =            {{EVO_FRIENDSHIP_DAY, 0, SPECIES_ESPEON, 0},
 	...
 	[SPECIES_PORYGON] =          {{EVO_TRADE_ITEM, ITEM_UP_GRADE, SPECIES_PORYGON2, 0},
 								  {EVO_ITEM, ITEM_UP_GRADE, SPECIES_PORYGON2, 0}},
 								 {{EVO_TRADE_ITEM, ITEM_FREE_SPACE_2, SPECIES_SHINX, 0},
 								  {EVO_ITEM, ITEM_FREE_SPACE_2, SPECIES_SHINX, 0}},
	...
	[SPECIES_QWILFISH] =         {{EVO_LEVEL, 38, SPECIES_TORTERRA, 0}},
	...
	[SPECIES_NOSEPASS] =         {{EVO_MAP, MAP_NAME_SIX_ISLAND, SPECIES_PROBOPASS, 0}},
	...
	[SPECIES_TURTWIG] =          {{EVO_LEVEL, 22, SPECIES_TANGELA, 0}},
	[SPECIES_MONFERNO] =         {{EVO_FRIENDSHIP, 0, SPECIES_MEOWTH, 0}},
	[SPECIES_INFERNAPE] =        {{EVO_LEVEL_NIGHT, 32, SPECIES_PIPLUP, 0}},
	[SPECIES_STARAVIA] =         {{EVO_LEVEL, 48, SPECIES_STARAPTOR, 0}},
	[SPECIES_BIDOOF] =           {{EVO_LEVEL, 1, SPECIES_BIBAREL, 0}},
	[SPECIES_KRICKETOT] =        {{EVO_LEVEL, 38, SPECIES_KRICKETUNE, 0}},
	...
	[SPECIES_CHARJABUG] =        {{EVO_MAP, MAP_NAME_SIX_ISLAND, SPECIES_VIKAVOLT, 0}},
	[SPECIES_CRABRAWLER] =       {{EVO_MAP, MAP_NAME_SIX_ISLAND, SPECIES_CRABOMINABLE, 0},
								  {EVO_MAP, MAP_NAME_SIX_ISLAND, SPECIES_NONE, 0},
								  {EVO_MAP, MAP_NAME_SIX_ISLAND, SPECIES_NONE, 0}},
